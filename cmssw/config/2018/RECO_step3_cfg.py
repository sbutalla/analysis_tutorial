...
# with command line options: step2 --filein file:HIG-RunIIAutumn18DRPremix-02737_step1.root --fileout file:HIG-RunIIAutumn18DRPremix-02737.root --mc --eventcontent AODSIM --runUnscheduled --datatier AODSIM --conditions 102X_upgrade2018_realistic_v15 --step RAW2DIGI,L1Reco,RECO,RECOSIM,EI --procModifiers premix_stage2 --nThreads 8 --era Run2_2018 --python_filename HIG-RunIIAutumn18DRPremix-02737_2_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 2626
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:HIG-RunIIAutumn18DRPremix-02737_step1.root'),
