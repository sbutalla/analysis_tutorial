...
# with command line options: step1 --fileout file:HIG-RunIIAutumn18MiniAOD-02755.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 102X_upgrade2018_realistic_v15 --step PAT --nThreads 8 --geometry DB:Extended --era Run2_2018 --python_filename HIG-RunIIAutumn18MiniAOD-02755_1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 8597
